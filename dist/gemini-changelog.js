...
var hasRequiredGeminiChangelog;

function requireGeminiChangelog () {
	if (hasRequiredGeminiChangelog) return geminiChangelog;
	hasRequiredGeminiChangelog = 1;
	const { exec } = require$$0;
	const fs = require$$1;
	const { GoogleGenerativeAI } = requireDist();
	...
	return geminiChangelog;
}

var geminiChangelogExports = requireGeminiChangelog();
var index = /*@__PURE__*/getDefaultExportFromCjs(geminiChangelogExports);

module.exports = index;
//# sourceMappingURL=gemini-changelog.js.map
